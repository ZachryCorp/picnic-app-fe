...
export const columns: ColumnDef<Submission>[] = [
  ...
  {
    header: "Children Reqeust Approved",
    accessorKey: "childrenRequestApproved",
  },
  {
    header: "Has Children Verification Status",
    id: "hasChildrenVerificationStatus",
    accessorFn: (row) => {
      // Return true if verified: either approved OR doesn't require verification
      // Return false if not verified: requires verification but not approved
      return !row.childrenVerification || row.childrenRequestApproved === true;
    },
    filterFn: (row, _, value: boolean | null) => {
      if (value === null) return true;
      const isVerified =
